...
# Missing variable defaults can lead to runtime errors or unexpected behavior
# Project: vertex-ai-search

set -euo pipefail

echo "🔍 Checking variable defaults for vertex-ai-search..."
...
echo "🔍 Checking for variable default assignments in vertex-ai-search..."
echo
