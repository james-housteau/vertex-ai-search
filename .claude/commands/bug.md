...
### Common Blockers for Bug Fixes
- Test failures (regression tests or existing tests)
- Code quality failures (linting, typing)
- Missing dependencies
- Cannot reproduce the bug
- Bug is symptom of deeper architectural issue
- Fix would break existing functionality
- Multiple bugs discovered in same area
